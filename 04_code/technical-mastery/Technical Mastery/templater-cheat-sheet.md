...
- [[#d_at_a_s_ov_er_ei_gn_tys_ta_rt a command snippet|Start a command snippet]]
- [[#d_at_a_s_ov_er_ei_gn_tyf_un_ct_io_n in Templater|Functions in Templater]]
	- [[#d_at_a_s_ov_er_ei_gn_tyt_yp_es of functions|Types of functions]]
	- [[#d_at_a_s_ov_er_ei_gn_tyo_bj_ec_t hierarchy|Object hierarchy]]
	- [[#d_at_a_s_ov_er_ei_gn_tyf_un_ct_io_n invocation|Function invocation]]
	- [[#d_at_a_s_ov_er_ei_gn_tyf_un_ct_io_n documentation syntax|Function documentation syntax]]
	- [[#d_at_a_s_ov_er_ei_gn_tyf_un_ct_io_n Modules|Function Modules]]
		- [[#d_at_a_s_ov_er_ei_gn_tyc_on_fi_g Module|Config Module]]
		- [[#d_at_a_s_ov_er_ei_gn_tyd_at_e module|Date module]]
		- [[#d_at_a_s_ov_er_ei_gn_tyf_il_e Module|File Module]]
		- [[#d_at_a_s_ov_er_ei_gn_tyf_ro_nt_ma_tt_er Module|Frontmatter Module]]
		- [[#d_at_a_s_ov_er_ei_gn_tyo_bs_id_ia_n Module|Obsidian Module]]
		- [[#d_at_a_s_ov_er_ei_gn_tys_ys_te_ms Module|Systems Module]]
		- [[#d_at_a_s_ov_er_ei_gn_tyw_eb Module|Web Module]]
	- [[#d_at_a_s_ov_er_ei_gn_tyu_se_r Functions|User Functions]]
		- [[#d_at_a_s_ov_er_ei_gn_tys_cr_ip_t User Functions|Script User Functions]]
		- [[#d_at_a_s_ov_er_ei_gn_tys_ys_te_m Commands|System Commands]]
	- [[#d_at_a_s_ov_er_ei_gn_tyc_om_ma_nd Types|Command Types]]
		- [[#d_at_a_s_ov_er_ei_gn_tyd_yn_am_ic commands|Dynamic commands]]
		- [[#d_at_a_s_ov_er_ei_gn_tye_xe_cu_ti_on Commands|Execution Commands]]
		- [[#d_at_a_s_ov_er_ei_gn_tyw_hi_te_sp_ac_e Control|Whitespace Control]]
...
-   `include_link`: The link to the file to include, e.g. MyFile, or a TFile object. Also supports sections or blocks inclusions, e.g. MyFile#d_at_a_s_ov_er_ei_gn_tys_ec_ti_on1
